...
function csvJSON(csv, keepMaryland){ //Convert CSV to JSON
    var lines = csv.split("\n");
    var result = [];
    ...
    result = result.map(function (recordToMap) {
        ...
        else if (recordToMap.buyer_name.includes("Maryland")) {
            // recordToMap.buyer_name = "";
            recordToMap.extra_info = "Maryland";
            if (keepMaryland)
                recordToMap.buyer_name = "KMaryland";
            else
                recordToMap.buyer_name = ""
        }
        else if (recordToMap.buyer_name.includes("Louisiana")) {
            // recordToMap.buyer_name = "";
            recordToMap.extra_info = 'Louisiana';
            if (keepMaryland)
                recordToMap.buyer_name = "KLouisiana";
            else
                recordToMap.buyer_name = ""
        }
