...
function controllerMain() {
    ...
    //    Dropdown Buyer - set based on selected option
        ...
        $('#dropdownOptionJBatey').click(function () {
            ...
            $("#dropdownBuyerButton").html("West Oak");
            updateFilterConditionsForSelect();
        });
        $('#dropdownOptionHJohnson').click(function () {
            buyerFilterOption = "Henry Johnson";
            $("#dropdownBuyerButton").html("Chatham");
            updateFilterConditionsForSelect();
        });
        $('#dropdownOptionOtherMaryland').click(function () {
            buyerFilterOption = "Maryland";
            $("#dropdownBuyerButton").html("Other Maryland");
            updateFilterConditionsForSelect();
        });
        $('#dropdownOptionOtherLouisiana').click(function () {
            buyerFilterOption = "Louisiana";
            $("#dropdownBuyerButton").html("Other Louisiana");
            updateFilterConditionsForSelect();
        });
    ...
    function getCombinedFilter() { //build filter for data based on options on right side
        ...
        var buyerFilter = function (p) {
            if (buyerFilterOption === "any")
                return true;
            else if (buyerFilterOption === "Maryland" || buyerFilterOption === "Louisiana")
                return p.extra_info === buyerFilterOption;
            else
